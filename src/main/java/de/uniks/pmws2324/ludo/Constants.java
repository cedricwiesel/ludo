...
public class Constants {
    ...
    public static final int PLAYER_ONE_OUT_X = 750;
    public static final int PLAYER_ONE_OUT_Y = 117;
    public static final int PLAYER_TWO_OUT_X = 750;
    public static final int PLAYER_TWO_OUT_Y = 472;
    public static final int PLAYER_THREE_OUT_X = 392;
    public static final int PLAYER_THREE_OUT_Y = 472;
    public static final int PLAYER_FOUR_OUT_X = 392;
